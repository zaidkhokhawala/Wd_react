...
function Contact() {
  return (
    <div><section className="contact-section bg-black">
  ...
  <footer className="footer bg-black small text-center text-white-50"><div className="container px-4 px-lg-5">Copyright © Your Website 2023</div></footer></div>
