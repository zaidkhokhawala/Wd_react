...
<>
                <div className="containe-fluid mark px-4 px-lg-5">
                    <div className="animate mark row gx-0 mb-4 mb-lg-5 align-items-center">
                        <div className="col-xl-8 col-lg-7">    < img class="img-fluid mb-3 mb-lg-0" src = { demo1 } alt = "..." />
                        </div>
                        <div className="col-xl-4 col-lg-5 ">
                            <div className="featured-text text-center text-lg-left">
                                <h4 classname="text-white">Shoreline</h4>
                    ...
                    <div className="row gx-0 mb-5 mb-lg-0 justify-content-center">
                        <div className="col-lg-6">        <img class="img-fluid" src={demo2} alt="..." /></div>
